...
<form action="" id="admin-csrf">
                ...
                <div class="header__inner">
                    <div class="header__top">
                        ...
                        <a href="tel:+7 (495) 596-65-65" class="header__contacts-mobile">
                            <img src="{{ asset('images/call.svg') }}" alt="img">
                        </a>
                    </div>
    ...
    <div class="popups">
      ...
      <span id="close">
        <img src="{{ asset('images/clear.svg') }}" alt="img">
      </span>
            ...
            <form class="request-popup__form">
                ...
                <div class="request-popup__cv">
                    <div class="request-popup__cv-text">
                        Прикрепить резюме
                    </div>
                    <a href="#" class="request-popup__cv-link">
                        Загрузить файл
                    </a>
                </div>
                <a href="#done-popup" class="popup" data-effect="mfp-zoom-in" type="submit">
                    отправить
                </a>
      ...
      <span id="close-done">
        <img src="{{ asset('images/clear-done.svg') }}" alt="">
      </span>
            <div class="done-popup__image">
                <img src="{{ asset('images/done.svg') }}" alt="">
            </div>
